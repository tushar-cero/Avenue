...
const MenuToggle = (openValue) => {
	const [ToggleChecker, setToggleChecker] = useState(openValue);
	...
	return (
		<div id="menu_toggle" className="menu_toggle">
			<button
				onClick={() => handleNav(ToggleChecker)}
				aria-label="Right Align">
				<div className="menu_toggle_toggle">
					<div
						id="menu_bar_top"
						className="menu_bar menu_bar_top"></div>
					<div
						id="menu_bar_bottom"
						className="menu_bar menu_bar_bottom"></div>
				</div>
			</button>
		</div>
	);
